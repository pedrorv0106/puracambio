ADMIN_EMAIL = 'admin@puracambio.com'
...
if Rails.env == 'development'
  ...
  foo = Identity.create(email: 'admin2@puracambio.com', password: NORMAL_PASSWORD, password_confirmation: NORMAL_PASSWORD, is_active: true)
  ...
  bar = Identity.create(email: 'developer@puracambio.com', password: NORMAL_PASSWORD, password_confirmation: NORMAL_PASSWORD, is_active: true)
